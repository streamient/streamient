...
const auditLogSchema = new mongoose.Schema(
    {
        ...
        resource: {
            type: String,
            required: true,
	            enum: ['note', 'memory', 'url', 'email', 'email_draft', 'email_internal_note', 'email_identity', 'project', 'link', 'user', 'passkey', 'conversation', 'trash', 'git_repo', 'team_member', 'team_invite', 'oauth_client', 'oauth_consent'],
        },
