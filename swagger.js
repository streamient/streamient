            ...
            Email: {
                ...
                properties: {
                    ...
                    source: { type: 'string', enum: ['api', 'emailforwarding'] },
	                    ...
	                    triage_primary_action: { type: 'string', enum: ['reply-required', 'human-do', 'waiting', 'marketing', 'no-action', 'spam'] },
	                ...
	                properties: {
	                    ...
	                    smtp: {
	                        ...
	                        properties: {
	                            ...
	                            auth_password_configured: { type: 'boolean', description: 'True when an encrypted SMTP password is stored. The secret value is never returned.' },
	                            tls: { type: 'boolean', description: 'Use Nodemailer requireTLS for outbound sending.' },
	                            ...
	                            'application/json': {
	                                schema: {
	                                    ...
	                                    properties: {
	                                        ...
	                                        email_identities: { type: 'array', items: { $ref: '#/components/schemas/EmailIdentity' } },
	                                    },
	                                },
	                            },
	                        },
        ...
        '/emails/triage-status': {
            get: {
                ...
                parameters: [
                    ...
                    { name: 'primary_action', in: 'query', description: 'Comma-separated primary actions', schema: { type: 'string', enum: ['reply-required', 'human-do', 'waiting', 'marketing', 'no-action', 'spam'] } },
        ...
        '/emails/triage-runs/{run_id}': {
	        ...
	        '/emails/spam': {
	            delete: {
	                ...
	                description: 'Permanently deletes all non-trash spam emails for the current tenant. Requires confirm=true.',
	                ...
	                responses: {
	                    ...
	                    400: { description: 'Missing confirmation', content: { 'application/json': { schema: { $ref: '#/components/schemas/Error' } } } },
	                },
	            },
	        },
	        '/emails/{id}': {
        ...
        '/git-repos/{id}/logs': {
	        ...
	        '/projects/{id}/email-identities': {
	            get: {
	                ...
	                summary: 'List project outbound email identities',
	                description: 'Returns masked project-owned email addresses with SMTP settings. Requires owner/admin and Email Pro feature access.',
	                parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' }, description: 'Project ID' }],
	                responses: {
	                    200: { description: 'OK', content: { 'application/json': { schema: { type: 'object', properties: { identities: { type: 'array', items: { $ref: '#/components/schemas/EmailIdentity' } } } } } } },
	                    403: { description: 'Plan or access denied', content: { 'application/json': { schema: { $ref: '#/components/schemas/Error' } } } },
	                },
	            },
	            post: {
	                tags: ['Email Identities'],
	                summary: 'Create a project outbound email identity',
	                parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' }, description: 'Project ID' }],
	                requestBody: {
	                    required: true,
	                    content: {
	                                ...
	                                properties: {
	                                    ...
	                                    smtp: {
	                                        ...
	                                        properties: {
	                                            ...
	                                            auth_user: { type: 'string' },
	                                            auth_password: { type: 'string', description: 'Stored encrypted and never returned.' },
	                ...
	                responses: {
	                    201: { description: 'Created', content: { 'application/json': { schema: { type: 'object', properties: { identity: { $ref: '#/components/schemas/EmailIdentity' } } } } } },
	                    400: { description: 'Validation error', content: { 'application/json': { schema: { $ref: '#/components/schemas/Error' } } } },
	                    403: { description: 'Plan or access denied', content: { 'application/json': { schema: { $ref: '#/components/schemas/Error' } } } },
	        ...
	        '/email-identities/{id}': {
	            get: {
	                tags: ['Email Identities'],
	                summary: 'Get one outbound email identity',
	                parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }],
	                responses: {
	                    200: { description: 'OK', content: { 'application/json': { schema: { type: 'object', properties: { identity: { $ref: '#/components/schemas/EmailIdentity' } } } } } },
	                    404: { description: 'Not found', content: { 'application/json': { schema: { $ref: '#/components/schemas/Error' } } } },
	                },
	            },
	            put: {
	            ...
	            delete: {
	                tags: ['Email Identities'],
	                summary: 'Delete one outbound email identity',
	                parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }],
	                responses: {
	                    200: { description: 'Deleted', content: { 'application/json': { schema: { type: 'object', properties: { message: { type: 'string' } } } } } },
	                    404: { description: 'Not found', content: { 'application/json': { schema: { $ref: '#/components/schemas/Error' } } } },
