(() => {
  ...
  (function() {
    ...
    function buildSrcdoc(options) {
      ...
      return '<!doctype html><html data-st-email-theme="' + theme + '"><head><meta charset="utf-8"><meta http-equiv="Content-Security-Policy" content="' + escapeHtml(csp) + '"><base target="_blank"><style>' + baseCss(theme) + "</style></head><body>" + html + scripts + "</body></html>";
    }
