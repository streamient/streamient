...
## Optional: route URLs and email to separate projects

Open the extension's **Options** page (right‑click the toolbar icon → **Options**, or click the gear icon in the popup) and pick:
