...
The search modal's **View all results** opens the same results page used by AI search. Select individual records, the current page, or **all matching records**. Selection persists across pagination and clears when applying different filters.
